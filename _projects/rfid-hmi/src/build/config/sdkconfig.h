...
#define CONFIG_ESP_SPI_BUS_LOCK_FUNCS_IN_IRAM 1
...
#define CONFIG_FREERTOS_TIMER_SERVICE_TASK_CORE_AFFINITY 0xFFFFFFFF
...
#define CONFIG_FREERTOS_NO_AFFINITY 0xFFFFFFFF
...
#define CONFIG_LWIP_TCPIP_TASK_AFFINITY 0xFFFFFFFF
